...
const FAQ = () => {
    return (
        <section className={`h-auto xxs:w-[100%] md:w-[90%] flex items-center justify-center flex-col xxs:my-[25px] md:my-[75px]`}>
            ...
            <h2 className="h-auto xxs:w-[90%] lg:w-[900px] font-bold heading-gradient xxs:text-5xl sm:text-6xl md:text-7xl  text-center">Frequently asked questions</h2>
                <Accordion.Root type="single" className="h-auto w-[full] my-[50px] flex flex-wrap items-center justify-center" collapsible defaultValue="1">
                    ...
                    <Accordion.AccordionItem value="3" className="h-auto w-[900px] bg-altBackground text-white border border-altBorder p-[20px] my-[10px] rounded-md">
                        ...
                        <Accordion.AccordionContent className="h-auto my-[20px] text-sm text-white opacity-80">Emble can be used by any sort of team and company. Whether you are a Product Manager, a UX designer or engineer. If you need feedback on your product and designs, using Emble will help.</Accordion.AccordionContent>
                    </Accordion.AccordionItem>
                </Accordion.Root>
        </section>
