    ...
    return (
        <nav className="h-auto w-[100%] flex items-center justify-center">
            ...
            <div className="h-auto flex-grow xxs:hidden md:flex items-center justify-center">
                <Link className="px-[10px] mx-[20px] text-white opacity-70" href="/">Blog</Link>
                <Link className="px-[10px] mx-[20px] text-white opacity-70" href="/use-cases">Use cases</Link>
                <Link className="px-[10px] mx-[20px] text-white opacity-70" href="/changelog">Changelog</Link>
                <Link className="px-[10px] mx-[20px] text-white opacity-70" href="/pricing">Pricing</Link>
            </div>
