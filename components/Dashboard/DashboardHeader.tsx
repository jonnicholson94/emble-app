...
const DashboardHeader = () => {
    return (
        <div className="h-[60px] w-full flex items-center justify-center bg-white border-b border-border">
            ...
            <div className="h-auto xxs:w-[45%] s:w-[47%] md:w-[48%] flex items-center justify-end">
                <Link className="h-[40px] px-3 flex items-center justify-center border border-border rounded-md" href="/settings">
                    <img className="h-[20px] w-[20px] mx-[5px]" src="/settings.svg" />
                    <p className="md:flex xs:hidden mx-2">Settings</p>
                </Link>
                <Link className="h-[40px] px-3 bg-black text-white font-bold items-center justify-center flex rounded-md ml-[10px]" href="/create-research">
                <img className="h-[20px] w-[20px] mx-[5px]" src="/add-white.svg" />
