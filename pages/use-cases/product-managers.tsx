...
const ProductManagers = () => {
    return (
        <section className="h-auto w-screen flex items-center justify-center flex-col bg-background">

            <Navbar />

            <section className="h-auto w-screen flex items-center justify-center flex-col mt-[100px] mb-[100px]">
                <p className={`xxs:w-[90%] lg:w-[70%] text-link uppercase font-bold text-lg my-[20px]`}>Product Managers</p>
                <h1 className="h-auto xxs:w-[90%] lg:w-[70%] font-bold xxs:text-5xl sm:text-6xl md:text-7xl mb-[30px]">Validate your product ideas, and push your roadmap forwards</h1>
                <BetaList />
            </section>

            <InfoSection tagline="Validate" heading="Test ideas out using prototypes">
