  ...
  return (
    <>
      ...
      <div className="h-auto w-screen flex items-center justify-center flex-col bg-[#000]">
        <Navbar />
        <Hero />
        <InfoSection tagColour="text-salmon" headingGradient="heading-gradient-1" tagline="Prototypes" heading="Conduct prototype tests with your users, remotely">
        ...
        <InfoSection tagColour="text-green" headingGradient="heading-gradient-2" tagline="Collaborative" heading="Work collaboratively, from product to design">
